...
| [capability-tier-reference.md](capability-tier-reference.md) | Cross-platform capability tier hierarchy: per-tier types, algorithms, sharing matrix, seed system, tier divergence | Reference |
| [c64-platform-guide.md](c64-platform-guide.md) | C64-specific hardware guidance: module mapping, CIA multiplexing, static stack allocation, cycle budgets, 6502 code style | Reference |
